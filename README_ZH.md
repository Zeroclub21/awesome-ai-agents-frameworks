# 卓越 AI 智能体 (AI Agents) 框架精选

面向商业落地与科研开发的顶尖 AI 智能体框架汇总。

**EN** | [RU](README_RU.md) | [ZH](README_ZH.md)

*最后更新于：2026-02-15 05:04:26*

| 排名 | 框架名称 | 星标数 | 编程语言 | 议题数 | 更新时间 | 变动 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
**您的个人专属 AI 助手。支持任何操作系统，任何平台。坚持“龙虾式”哲学。 🦞**
...
**AutoGPT 的愿景是让 AI 触手可及，供每个人使用和构建。我们的使命是提供工具，助您专注于核心事务。**

⭐ 181,811 · 🍴 46,223 · 👥 802 · 🛠️ Python · 📅 2026-02-14

- 由 GPT 模型驱动的自主 AI 智能体能力
- 递归式自我提示（Self-prompting），用于任务分解与执行
- 集成网页浏览、文件 I/O 等外部工具
- 具备高扩展性与定制化能力的开源框架
...
**开源 AI 编排框架，用于构建经过上下文工程优化的生产级 LLM 应用。设计模块化流水线和智能体工作流，对检索、路由、记忆和生成进行显式控制。专为可扩展智能体、RAG、多模态应用、语义搜索及对话系统打造。**
...
- 利用 LLM 提示词实现自主任务生成
- 基于向量的嵌入（Embeddings）与相似度搜索任务优先级排序
...
- 与 MicroPython 和 C++ 无缝集成，实现快速原型开发与部署
...
**支持 Python 和 Typescript 的生产级 AI 智能体构建。**
...
- 完全在个人电脑本地执行，无需云端依赖
- 支持与 GPT-OSS、Qwen 和 GLM 等本地 LLM 集成
