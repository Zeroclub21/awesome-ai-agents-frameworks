...
针对商业化落地与研发创新所筛选的顶尖 AI Agent 框架集合。

**EN** | [RU](README_RU.md) | [ZH](README_ZH.md)

*最后更新：2026-02-14 18:54:53*

| 排名 | 框架 | 星标数 | 开发语言 | 开源协议 | 变动 |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
**您的私人 AI 助手。支持任何操作系统，任何平台。坚持“龙虾式”开发理念。 🦞**
...
- 递归自我提示（Self-prompting），实现任务分解与执行
- 集成外部工具，如网页浏览和文件 I/O
- 具备高扩展性与定制化的开源框架
...
- 大模型中立（LLM-agnostic）设计，支持多家模型供应商
...
- 角色扮演型 AI 智能体编排
- 支持自主智能体执行
- 培育协同智能（Collaborative Intelligence）
- 针对复杂任务的无缝多智能体协作

### <a name="agno"></a>[agno](https://github.com/agno-agi/agno)
**构建能够通过每次交互学习并进化的多智能体系统。**
...
- 基于交互的实时在线学习
- 持续改进的自适应反馈循环
- 交互记忆与经验回放（Experience Replay）机制
...
**开源 AI 编排框架，用于构建经过上下文工程化处理的生产级 LLM 应用。设计模块化流水线和智能体工作流，对检索、路由、记忆和生成进行显式控制。专为可扩展智能体、RAG、多模态应用、语义搜索和对话系统打造。**
...
- 利用 LLM 提示词实现自主任务生成
- 基于向量的嵌入（Embeddings）与相似度搜索实现任务优先级排序
...
**🐫 CAMEL：首个且领先的多智能体框架。探索智能体缩放定律（Scaling Law of Agents）。https://www.camel-ai.org**
...
**PraisonAI 是一款生产级多 AI 智能体框架，旨在创建 AI 智能体以自动化解决从简单任务到复杂挑战的各类问题。它提供低代码解决方案，简化多智能体 LLM 系统的构建与管理，强调简单性、定制化及高效的人机协作。**
...
**基于 Rust 构建的私人 AI 助手。单一二进制文件，支持多供应商 LLM、长期记忆、沙箱化执行、语音、MCP 工具及多渠道访问（Web、Telegram、API）。**
...
**多功能近端本地化助手（Versatile Almost Local, Eventually Reasonable Assistant） 🔫**
